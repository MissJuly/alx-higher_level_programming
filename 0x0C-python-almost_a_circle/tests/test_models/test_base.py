...
class BaseInstantiationTestCase(unittest.TestCase):
    """unittest for testing instantiation for the Base class."""
...
class BaseFromJsonStringTestCase(unittest.TestCase):
    ...
    def test_from_json_string_one_square(self):
        list_input = [{"id": 20, "size": 12, "x": 9, "y": 4}]
    ...
    def test_from_json_string_two_squares(self):
        list_input = [
            {"id": 20, "size": 12, "x": 9, "y": 4},
            {"id": 22, "size": 10, "x": 7, "y": 5}
        ]
        json_list_input = Square.to_json_string(list_input)
        list_output = Square.from_json_string(json_list_input)
        self.assertEqual(list_input, list_output)
...
class BaseCreateTestCase(unittest.TestCase):
    ...
    def test_create_square_original(self):
        ...
        self.assertEqual("[Square] (7) 5/2 - 3", str(s1))

    def test_create_square_new(self):
        s1 = Square(3, 5, 2, 7)
        s1_dictionary = s1.to_dictionary()
        s2 = Square.create(**s1_dictionary)
        self.assertEqual("[Square] (7) 5/2 - 3", str(s2))
...
class BaseSaveToFileCSv(unittest.TestCase):
    ...
    def test_save_file_csv_two_rectangles(self):
        r1 = Rectangle(10, 7, 2, 8, 5)
        r2 = Rectangle(2, 4, 1, 2, 3)
    ...
    def test_save_to_file_csv_more_than_one_args(self):
        with self.assertRaises(TypeError):
            Square.save_to_file_csv()


class BaseLoadFromFileCSVTestCase(unittest.TestCase):
    """Unittests for testing load_from_file_method of Base."""
